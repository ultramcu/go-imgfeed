...
- `genaidapter` subpackage for Google's Gen AI SDK (`google.golang.org/genai`,
  used by Gemini models): `Part` (inline image Blob) and `Text`.
...
[0.2.0]: https://github.com/ultramcu/go-imgfeed/releases/tag/v0.2.0
